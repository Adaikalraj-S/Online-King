  ...
  return (
    <>
      <div className="auth-wrapper">
        ...
        <div className="auth-wrapper-right relative">
          <Image
            src="images/OnlineKingLogo.svg"
            width={1000}
            height={1000}
            alt="image"
            className="w-24 object-contain absolute top-2"
          />
          <h2 className="absolute top-24 left-1/3 font-bold text-4xl font-serif">
            Online King
          </h2>
          <div className="auth-wrapper-form ">
            <div className="auth-header">
              ...
              <button
                className="bg-[#ebc25b] p-2 rounded-[5px] text-black text-[14px] font-bold w-full mt-5 hover:bg-[#ebc25b]/70"
