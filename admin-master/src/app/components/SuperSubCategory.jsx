...
const SuperSubCategory = () => {
  ...
  const getEditData = async (e) => {
    const { value, name } = e.target;

    if(name === "edit_category_id") {
      const subCat = await fetchData("/api/fetch-subcategories", {category_id: value})
      console.log(subCat, "sub-cat")
      setSubCategoryData(subCat.subcategories)
    }
  ...
  const handleEdit = async (data) => {
    ...
    setEditData(data)
    if(data.category_id) {
      const subCat = await fetchData("/api/fetch-subcategories", {category_id: data.category_id})
      console.log(subCat, "sub-cat")
      setSubCategoryData(subCat.subcategories)
    }
    setGetSuperSubCategoryEdit({
      edit_category_id: data.category_id,
      edit_sub_category_id: data.sub_category_id,
      edit_super_sub_category_id: data.id,
      edit_super_sub_category_name: data.super_sub_category_name
    })
  }
        ...
        <div className=' py-[10px] flex flex-col space-y-5'>
          ...
          <div className='flex items-center justify-between gap-[10px]'>
            ...
            <div className='flex flex-col space-y-1 w-full'>
              ...
              <input type='text' placeholder='Super Sub Category' className='inputText' name='super_sub_category_name' id='super_sub_category_name' onChange={getData} />
            </div>
        ...
        >
          ...
          <DialogContent dividers>
            <div className='flex flex-col space-y-2 mb-2'>
              ...
              {/* <input type='text' value={editData.sub_category_name} className='inputText' placeholder='Ex: Colour' name='edit_sub_category_name' onChange={getEditData} /> */}
              <select value={getSuperSubCategoryEdit.edit_category_id} name='edit_category_id' onChange={getEditData}>
                <option>Choose Category</option>
            ...
            <div className='flex flex-col space-y-2 mb-2'>
              ...
              <select value={getSuperSubCategoryEdit.edit_sub_category_id} name='edit_sub_category_id'  onChange={getEditData}>
                <option>Choose Sub Category</option>
            ...
            <div className='flex flex-col space-y-2'>
              ...
              <input type='text' value={getSuperSubCategoryEdit.edit_super_sub_category_name} className='inputText' placeholder='Ex: Colour' name='edit_super_sub_category_name' onChange={getEditData} />
            </div>
