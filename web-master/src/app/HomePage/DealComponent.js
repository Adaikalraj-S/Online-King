...
const DealComponent = ({ productDetails }) => {
  const {
  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="bg-white w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto rounded-md shadow-xl flex flex-col justify-evenly">
