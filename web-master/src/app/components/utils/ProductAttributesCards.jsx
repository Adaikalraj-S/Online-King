...
const ProductAttributesCards = ({ attributes, onAttributeChange }) => {
    ...
    return (
        <div className="flex flex-col gap-4 py-2 overflow-hidden" style={{overflow: 'hidden !important'}}>
            {getAllAttributeTypes().map(type => (
                <div key={type} className="flex items-center justify-between gap-2 overflow-hidden">
                    <h4>{type}</h4>
...
export default ProductAttributesCards;